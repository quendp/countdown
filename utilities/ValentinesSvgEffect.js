...
export default function ValentinesSvgEffect() {
  const maxBound = 453.5;
  ...
  useEffect(() => {
    ...
    hearts.forEach((heart, i) => {
      // Position the heart container - spread across full width and start well below container
      gsap.set(heart, {
        x: random(-maxBound / 2, maxBound / 2),
        y: random(maxBound + 300, maxBound + 500),
        opacity: 0.9,
      });

      // Scale and stroke the heart instead of filling it
      ...
      // Adjust animation to end at a higher position
      gsap.to(heart, {
        x: `+=${random(-50, 50)}`,
        y: random(-maxBound, -maxBound / 2), // Higher end position
        opacity: 0,
        duration: random(5, 8),
        delay: i * 0.3,
        repeat: -1,
    ...
    // Letters animation using strokeDasharray/strokeDashoffset instead of drawSVG
    ...
    letters.forEach((letter) => {
      ...
      gsap.set(letter, {
        ...
        fill: "transparent",
        scale: 2,
        y: -400, // Added this line to move letters up by 50 units
      });
    });
  ...
  return (
    ...
    >
      <defs>
        <symbol id="heart" viewBox="-2 -2 25 25">
          <path
            d="M16.6,0c-4.6-0.3-5.9,3.2-5.9,3.2S7.9-1.1,4,0.4C0.1,1.8-2.7,8.5,4.3,14.3c5.4,4.5,6.2,4.5,6.2,4.5
            s0.8,0,6.7-4.8C24,8.3,21.2,0.4,16.6,0z"
          />
        </symbol>
      </defs>

      {[...Array(15)].map((_, i) => (
        <g key={i} className="heart-path" style={{ overflow: "visible" }}>
          <use xlinkHref="#heart" />
        </g>
      ))}
      ...
      <g>
        <path
          ...
          fill="none"
          d="M237.4,150.5c1.9-4.3,3.6-7.5,5.1-9.7c1.5-2.2,2.9-3.5,4.1-4c1.3-0.5,2.2-0.7,2.6-0.7
...
c-0.5,0-1.5,1-3,2.9c2.6-0.4,3.9-1.1,3.8-2.1c0-0.4-0.3-0.7-0.7-0.8C225,135.6,225,135.6,224.9,135.6z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M258.4,164.7c-1.2,2.3-1.9,4-2.1,5.1c-0.2,1.1-0.4,2.1-0.4,2.8c0,0.7,0.3,1.1,0.8,1.1
...
c0.5-0.5,1.1-0.7,1.8-0.7c0.1,0,0.5,0.1,1.1,0.2c0.6,0.1,1,0.1,1.3,0.1C260.5,160.9,259.6,162.4,258.4,164.7z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M279.2,165.8c0,1.8-0.5,3.8-1.4,6c-1,2.2-2.3,4.3-3.9,6.3c-1.7,2-3.7,3.4-6.1,4.1c-0.9,0.2-2,0.4-3.1,0.4
...
C275.7,168.4,276.3,166.6,276.3,165.2z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M301.1,159.9c0,1.6-0.4,3.3-1.2,5.2c-0.8,1.9-2,3.7-3.4,5.5c-1.5,1.8-3.2,3-5.3,3.6
...
c2.4-2,4.4-4.5,6.1-7.5C298,162.2,298.5,160.6,298.5,159.4z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M290.7,205.6c-1.8,0-3.2-0.4-4.2-1.1c-1-0.8-1.5-1.7-1.5-2.7s0.3-2.3,0.9-3.6c1.1-2.1,3-3.8,5.8-5.1
...
c-6.8,1.8-11.1,3-12.8,3.8C290.2,195.5,288.3,197.2,287.1,199.5z"
        />
        ...
        <path
          ...
          strokeAlignment="outer"
          fill="none"
          d="M139.7,242c-0.5,0-1-0.1-1.5-0.2c-2.6-0.5-4-2.8-4-7c0-6.7,3.4-18.2,10.2-34.5c2.6-6.1,4.6-12.1,5.8-17.9
...
C147.1,240.3,142.9,242,139.7,242z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M190.8,222.8c-1.6,3.1-2.6,5.5-2.9,7c-0.3,1.6-0.5,2.8-0.5,3.8s0.4,1.4,1.1,1.4c0.9,0,2.1-0.9,3.5-2.6
...
c0.2,0,0.7,0.1,1.5,0.2c0.8,0.1,1.4,0.2,1.8,0.1C193.6,217.7,192.4,219.7,190.8,222.8z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M202.8,215.9c-0.5,1.6-1,3-1.3,4.5c-0.4,1.4-0.5,2.8-0.5,4.3c0,1.4,0.3,2.7,1,4c0.7,1.2,1.7,1.8,3.2,1.8
...
c-0.7,0-1.9,1.3-3.8,3.9c-1.9,2.6-4.3,7.3-7.5,14.1c-3.1,6.8-5.7,12.7-7.7,17.8C207.8,206.5,211.2,202.2,214.5,197z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M217.3,220.5c-0.7,1.8-1.1,3.8-1.1,6c0,1.5,0.3,2.6,1,3.5c0.7,0.9,1.6,1.3,2.8,1.3c4.8,0,9.1-4.5,12.9-13.4
...
c0.9,0,2.2-0.3,3.9-0.9c1.7-0.6,3.2-1.5,4.4-2.5C229.1,213.2,230.5,210.7,230.5,207.9z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M247.8,215.5c-5.1,8.9-7.6,14.7-7.6,17.5c0,1.1,0.4,1.6,1.2,1.6c2.1,0,4.9-3.6,8.5-10.7
...
C247.4,215.4,247.6,215.4,247.8,215.5z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M246.1,237.6c0-4.7,2.2-12.5,6.7-23.4h-4.4c-0.3,0-0.5-0.2-0.5-0.5c-0.1-0.3-0.1-0.6,0.1-0.9
...
M263,212.3c3.7-6.6,5.6-11.2,5.6-13.8c0-1.1-0.2-1.7-0.6-1.7c-0.6,0-1.6,0.9-2.8,2.7c-1.3,1.8-3.4,6.1-6.4,12.8H263z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M268.3,236.6c0.8,0,1.6-0.4,2.5-1.2c1.5-1.5,3.5-4.7,5.8-9.4c0.3-0.6,0.6-0.8,0.9-0.6
...
C275.3,212.7,275,213.3,274.4,213.8z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M294.5,223.8c-6.3,11-9.4,18.2-9.4,21.5c0,1.3,0.5,2,1.4,2c2.6,0,6.1-4.4,10.5-13.2c0.3-0.7,0.6-1,0.9-0.8
...
c-1.9,1-5,5.8-9.2,14.3c2.4-2.9,4.6-5.3,6.5-7.1c2-1.8,4.3-3.4,7.1-4.9c2.7-1.5,4.8-2.3,6-2.3C294,223.6,294.3,223.7,294.5,223.8z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M303.3,230.4c-0.8,1.9-1.2,4-1.2,6.4c0,1.6,0.3,2.8,1,3.7c0.7,0.9,1.7,1.4,3,1.4c5.1,0,9.7-4.8,13.8-14.3
...
c0.9,0,2.3-0.3,4.1-1c1.8-0.7,3.4-1.6,4.7-2.7C315.8,222.7,317.4,219.9,317.4,217z"
        />
        <path
          className="letter-path"
          strokeAlignment="outer"
          fill="none"
          d="M334.1,210c0,2.2-0.8,4.1-2.3,5.6c-1.6,1.5-3.4,2.6-5.4,3.3c-0.2,0.1-0.4,0.2-0.5,0.2
...
C333.8,207.9,334.1,208.9,334.1,210z"
        ...
        <path
          ...
          strokeAlignment="outer"
          fill="none"
          d="M344.1,240c0.7,0.1,1.2,0.2,1.5,0.2c2.3,0,4.5-1.3,6.7-4c1.2-1.5,3.3-5.2,6.4-11.1c0.1-0.3,0.3-0.4,0.6-0.4
...
c1.2,0,1.8,0.8,1.8,2.5C337.6,236,338.8,238.2,341.2,239.4z"
        ...
        <g>
          <path
            ...
            strokeAlignment="outer"
            fill="none"
            d="M194.5,285.1c-3.9,3.1-8.2,4.7-13,4.7c-5.4,0-8.7-1.5-10-4.5c-0.3-0.7-0.4-1.5-0.4-2.5
...
c-1.2,1.9-3.6,5.7-7,11.4c-3.5,5.7-6.4,10.4-8.8,13.9c-2.4,3.6-4.3,6.1-5.7,7.6C198.1,282.1,196.9,283.2,196,283.9z"
          ...
          <path
            ...
            strokeAlignment="outer"
            fill="none"
            d="M248.9,283.7c-1.1,2.1-1.8,3.7-2,4.7c-0.2,1-0.3,1.9-0.3,2.5c0,0.6,0.2,1,0.7,1c0.6,0,1.4-0.6,2.3-1.7
...
c0.1,0,0.5,0.1,1,0.1c0.5,0.1,1,0.1,1.2,0.1C250.9,280.3,250,281.6,248.9,283.7z"
          ...
          <path
            ...
            strokeAlignment="outer"
            fill="none"
            d="M245,315.9c-2,0-3.5-0.4-4.6-1.3c-1.1-0.8-1.6-1.8-1.6-3c0-1.2,0.3-2.5,1-4c1.2-2.3,3.3-4.2,6.4-5.6
...
c-7.4,1.9-12.1,3.3-14.1,4.2C244.4,304.8,242.3,306.7,241,309.2z"
          ...
          <path
            className="letter-path heart"
            fill="none"
            d="M337.3,134c-9.9-0.7-12.8,6.9-12.8,6.9s-6.1-9.3-14.5-6.2c-8.5,3.1-14.3,17.5,0.6,29.9
c11.7,9.8,13.5,9.7,13.5,9.7s1.7,0,14.4-10.4C353.2,151.9,347.2,134.7,337.3,134z M336.9,163.4c-12.1,10-12.9,9.9-12.9,9.9
s-0.7,0.1-11.9-9.3c-14.3-12-9.6-25.5-1.5-28.5c8.1-3,13.7,7.5,13.7,7.5s2.9-8.9,12.4-8.2C346.2,135.5,351.1,151.7,336.9,163.4z"
          />
        </g>
      </g>
    </svg>
